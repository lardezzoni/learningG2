...
def write_instructors():
    ...
    print("All instructors objects saved.")
...
def clean_data():
    ...
    #Delete all data 
    #Get an Enrollment model object, select them all
    #since .all() = SELECT * FROM Table
...
def write_learners():
    ...
    learner_luiz = Learner(first_name='Luiz', last_name='Ardezzoni', dob=date(1986, 3, 16),
                           occupation='developer',
                           social_link='https://www.linkedin.com/luiz/')
    learner_luiz.save()
